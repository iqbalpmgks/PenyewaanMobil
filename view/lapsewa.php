...
if (isset($_POST['submit'])) {
  ...
  if ($simpan) {
    echo "<script>alert('Laporan Penyewaan Siap di Cetak!');window.location='cetaklapsewa.php?tgl_awal=$tgl_awal&&tgl_akhir=$tgl_akhir';</script>";
  } else {
    echo "<script>alert('Laporan Penyewaan Gagal di Cetak!');window.location='lapsewa.php';</script>";
  }
}
?>
...
<div id="page-wrapper">
  <div class='row'>
    <div class='col-lg-12'>
      <h3 class="page-header"><span class="glyphicon glyphicon-file"></span> Cetak Laporan Penyewaan</h3>
    </div>
  </div>

  <div class="row">
    <div class="col-lg-12">
      <form action="lapsewa.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
